...
Private Sub SaveItem()
        If m_ucmStorage.Items.Count > 0 And lvwRecords.SelectedItem > -1 Then
            With New cFileDlg
                .Filters.AddFilter m_ucmStorage.Items(Val(lvwRecords.SubItemText(lvwRecords.SelectedItem, 0))).strType & "文件", "*." & m_ucmStorage.Items(Val(lvwRecords.SubItemText(lvwRecords.SelectedItem, 0))).strType
                .FilterIndex = 2
